...
@user1 = User.create!(username: 'test', email: 'test@gmail.com', phone_number: 5407978445, password: '123456')
...
@meal10 = Meal.create!(name: 'Shrimp Scampi', image: 'https://img.hellofresh.com/c_fit,f_auto,fl_lossy,h_1100,q_auto,w_2600/hellofresh_s3/image/5f7dd483cf5c232eda4a5ed6-8eb9407c.jpg', description: 'Sauteed shrimp tossed with spaghetti in a garlic butter sauce with parmesan and lemon juice', price: 11)
